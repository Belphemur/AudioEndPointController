...
std::list<AudioDevice*>* AudioEndPointerController::getAudioDevices(int deviceFilter)
{
	TGlobalState state;
...
AUDIOENDPOINTCONTROLLER_API void AudioEndPointerController::createDeviceEnumerator(TGlobalState* state, std::list<AudioDevice*> * list)
{
	state->pEnum = NULL;
...
void AudioEndPointerController::prepareDeviceEnumerator(TGlobalState* state, std::list<AudioDevice*> * list)
{
...
void AudioEndPointerController::enumerateOutputDevices(TGlobalState* state, std::list<AudioDevice*> * list)
{
...
AudioDevice * AudioEndPointerController::buildAudioDevice(IMMDevice* pDevice, int index, LPWSTR strDefaultDeviceID)
{
	// Device ID
	LPWSTR strID = NULL;
...
std::wstring AudioEndPointerController::getDeviceProperty(IPropertyStore* pStore, const PROPERTYKEY key)
{
	PROPVARIANT prop;
...
HRESULT AudioEndPointerController::SetDefaultAudioPlaybackDevice(LPCWSTR devID)
{
